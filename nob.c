...
#ifndef CFLAGS_WIN
#  define CFLAGS_WIN " ./winresource/resource.o lib/windows/libraylib.a -lwinmm -lgdi32 -lopengl32 -I include/external/deps/mingw -L lib/windows/ --static "
#endif
